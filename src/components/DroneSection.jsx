...
export const DroneSection = () => {
  ...
  return (
    <section id="drone" className="py-24 bg-gradient-to-b from-[#0F172A] via-[#060B18] to-[#0F172A] relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-15 pointer-events-none">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#060B18] via-transparent to-[#060B18]" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <Reveal animation="fade-right">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#E8C37B]/10 border border-[#E8C37B]/30 rounded-full text-[#E8C37B] text-xs font-semibold tracking-widest uppercase">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              {droneFeatures.map((feat, idx) => (
                <Reveal key={idx} animation="fade-up" delay={250 + idx * 80}>
                  <div className="p-4 glass-card rounded-xl border border-white/10 hover:border-[#E8C37B]/40 transition-all">
                    <div className="flex items-center gap-2 mb-2 text-[#E8C37B]">
            ...
            <Reveal animation="fade-up" delay={550}>
              <div className="pt-4 flex flex-wrap items-center gap-4">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3.5 text-xs font-bold tracking-widest uppercase text-black bg-[#25D366] hover:bg-[#22bf5b] rounded-full transition-all shadow-lg transform hover:-translate-y-0.5"
                >
          ...
          <div className="lg:col-span-6">
            <Reveal animation="zoom-in" delay={200} duration={800}>
              <div className="relative rounded-2xl overflow-hidden glass-card-gold p-3 border border-[#E8C37B]/40 shadow-2xl group">
                ...
                <div className="relative h-96 sm:h-[480px] rounded-xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-16 h-16 rounded-full bg-[#E8C37B]/90 text-black flex items-center justify-center shadow-[0_0_30px_#E8C37B] group-hover:scale-110 transition-transform">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 p-4 glass-card rounded-xl border border-white/15">
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="text-[10px] tracking-widest uppercase text-[#E8C37B] font-bold">Equipment Spec</span>
                        <h4 className="font-serif-luxury text-lg font-bold text-white">DJI Mavic 3 Pro Cine Dual-Cam</h4>
                      </div>
                      <span className="px-3 py-1 bg-[#E8C37B]/20 border border-[#E8C37B]/40 text-[#E8C37B] text-[10px] uppercase font-bold rounded">
                        Apple ProRes 422
                      </span>
                    </div>
                  </div>

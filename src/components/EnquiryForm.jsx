...
export const EnquiryForm = ({ selectedService, selectedPackage }) => {
  ...
  return (
    <section id="enquiry" className="py-24 bg-[#0D0D0D] relative">
      
      {/* Background Ambient Light */}
      <div className="absolute top-1/3 right-0 w-96 h-96 bg-[#D4AF37]/5 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-4">
          ...
          <h2 className="font-serif-luxury text-3xl sm:text-5xl font-bold text-white">
            Send an Direct <span className="gold-gradient-text italic font-normal">WhatsApp Enquiry</span>
          </h2>
        ...
        {/* Main Form Container */}
        <div className="glass-card-gold rounded-3xl p-6 sm:p-10 border border-[#D4AF37]/30 shadow-2xl">
          ...
          {submitted ? (
            <div className="py-12 text-center space-y-4 animate-fadeIn">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#25D366] text-black font-bold text-xs uppercase tracking-wider rounded-full shadow-lg hover:bg-[#22bf5b] transition-all"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-11 pr-4 py-3 bg-black/60 border ${errors.fullName ? 'border-red-500' : 'border-white/15 focus:border-[#D4AF37]'} rounded-xl text-sm text-white placeholder-gray-600 focus:outline-none transition-colors`}
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-11 pr-4 py-3 bg-black/60 border ${errors.phone ? 'border-red-500' : 'border-white/15 focus:border-[#D4AF37]'} rounded-xl text-sm text-white placeholder-gray-600 focus:outline-none transition-colors`}
                    />
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-3 bg-black/60 border border-white/15 focus:border-[#D4AF37] rounded-xl text-sm text-white placeholder-gray-600 focus:outline-none transition-colors"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-black/60 border border-white/15 focus:border-[#D4AF37] rounded-xl text-sm text-white focus:outline-none transition-colors"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full pl-11 pr-4 py-3 bg-black/60 border ${errors.eventDate ? 'border-red-500' : 'border-white/15 focus:border-[#D4AF37]'} rounded-xl text-sm text-white focus:outline-none transition-colors`}
                    />
                  </div>
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-300 uppercase tracking-wider mb-2">
                    Event Location / City <span className="text-[#D4AF37]">*</span>
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-11 pr-4 py-3 bg-black/60 border ${errors.location ? 'border-red-500' : 'border-white/15 focus:border-[#D4AF37]'} rounded-xl text-sm text-white placeholder-gray-600 focus:outline-none transition-colors`}
                    />
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-black/60 border border-white/15 focus:border-[#D4AF37] rounded-xl text-sm text-white focus:outline-none transition-colors"
                  >
                    <option value="1" className="bg-[#171717]">1 Day / Single Event</option>
                    <option value="2" className="bg-[#171717]">2 Days</option>
                    <option value="3" className="bg-[#171717]">3 Days</option>
                    <option value="4+" className="bg-[#171717]">4+ Days Grand Destination</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  >
                    {packageOptions.map(pkg => (
                      <option key={pkg} value={pkg} className="bg-[#171717]">
                        {pkg}
                      </option>
                    ))}
                  </select>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-black/60 border border-white/15 focus:border-[#D4AF37] rounded-xl text-sm text-white placeholder-gray-600 focus:outline-none transition-colors"
                ></textarea>
              </div>
